  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Link
          href="/search"
          className="flex items-center gap-3 p-5 rounded-xl border border-[var(--border)] bg-[var(--background)] hover:border-farenheit-300 dark:hover:border-farenheit-700 hover:shadow-sm hover:-translate-y-0.5 transition-all focus:outline-none focus:ring-2 focus:ring-farenheit-500"
        >
